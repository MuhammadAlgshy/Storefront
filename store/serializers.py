...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = ['id', 'cart_id', 'quantity', 'product', 'total_price']

    def total_item_price(self):
        return Product.unit_price * self['quantity']
...
class CustomerSerializer(serializers.ModelSerializer):
    ...
    user_name = serializers.SerializerMethodField(method_name='username')

    class Meta:
        model = Customer
        fields = ['id', 'user_id', 'user_name', 'phone', 'birth_date', 'membership']

    def username(self, request):
        return f'{request.user.first_name} {request.user.first_name}'
